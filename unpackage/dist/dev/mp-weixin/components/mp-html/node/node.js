...
const block0 = {};
const node = () => Promise.resolve().then(() => L1VzZXJzL2RuaHl4Yy9Eb2N1bWVudHMvbWluaXByb2dyYW0vZG5oeXhjL2NvbXBvbmVudHMvbXAtaHRtbC9ub2RlL25vZGUudnVl);
const _sfc_main = {
  name: "node",
  options: {
    virtualHost: true
  ...
  return {
    a: common_vendor.f($props.childs, (n, i, i0) => {
      return common_vendor.e({
        ...
        G: n.attrs.id,
        H: common_vendor.n((n.attrs.href ? "_a " : "") + n.attrs.class),
        I: common_vendor.s("display:inline;" + n.attrs.style),
        J: i,
        K: common_vendor.o((...args) => $options.linkTap && $options.linkTap(...args), i)
      } : n.name === "video" ? {
        M: n.attrs.id,
        N: common_vendor.n(n.attrs.class),
        O: common_vendor.s(n.attrs.style),
        P: n.attrs.autoplay,
        Q: n.attrs.controls,
        R: n.attrs.loop,
        S: n.attrs.muted,
        T: n.attrs["object-fit"],
        U: n.attrs.poster,
        V: n.src[$data.ctrl[i] || 0],
        W: i,
        X: common_vendor.o((...args) => $options.play && $options.play(...args), i),
        Y: common_vendor.o((...args) => $options.mediaError && $options.mediaError(...args), i)
      } : n.name === "audio" ? {
        aa: n.attrs.id,
...
const L1VzZXJzL2RuaHl4Yy9Eb2N1bWVudHMvbWluaXByb2dyYW0vZG5oeXhjL2NvbXBvbmVudHMvbXAtaHRtbC9ub2RlL25vZGUudnVl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null
