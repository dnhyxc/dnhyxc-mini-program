...
const plugins = [components_mpHtml_markdown_index.Markdown, components_mpHtml_highlight_index.Highlight, components_mpHtml_latex_index.Latex, components_mpHtml_style_index.Style];
const _sfc_main = {
  name: "mp-html",
  data() {
    return {
