...
function t() {
  ...
  var _ = function(e2, t3) {
    ...
    e2 && e2.sanitize && !e2.silent && common_vendor.index.__f__("warn", "at components/mp-html/markdown/marked.min.js:6", "marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options");
  }, Z = function(e2, t3) {
    if (t3 < 1)
      return "";
    for (var n2 = ""; 1 < t3; )
      ...
      for (void 0 === t4 && (t4 = []), void 0 === n3 && (n3 = true), e3 = e3.replace(/^ +$/gm, ""); e3; )
        if (r3 = this.tokenizer.space(e3))
          ...
          if (this.options.silent) {
            common_vendor.index.__f__("error", "at components/mp-html/markdown/marked.min.js:6", a2);
            break;
          }
          throw new Error(a2);
        }
      ...
      for (; e3; )
        if (l2 || (a2 = ""), l2 = false, i2 = this.tokenizer.escape(e3))
          ...
          if (i2 = this.tokenizer.inlineText(e3, r3, F))
            ...
            if (this.options.silent) {
              common_vendor.index.__f__("error", "at components/mp-html/markdown/marked.min.js:6", u2);
              break;
            }
            throw new Error(u2);
          }
      ...
      for (var n3, r2, i2, s2, l2, a2, o2, c2, u2, p2, h2, g2, f2, d2, k2, b2 = "", m2 = e3.length, x2 = 0; x2 < m2; x2++)
        switch ((c2 = e3[x2]).type) {
          ...
          default:
            ...
            if (this.options.silent)
              return void common_vendor.index.__f__("error", "at components/mp-html/markdown/marked.min.js:6", w2);
            throw new Error(w2);
        }
      return b2;
      ...
      for (var n3, r2 = "", i2 = e3.length, s2 = 0; s2 < i2; s2++)
        switch ((n3 = e3[s2]).type) {
          ...
          default:
            ...
            if (this.options.silent)
              return void common_vendor.index.__f__("error", "at components/mp-html/markdown/marked.min.js:6", l2);
            throw new Error(l2);
        }
      return r2;
    }, n2;
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/components/mp-html/markdown/marked.min.js.map
