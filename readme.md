        ...
        try {
          if (lineNumber) {
            ...
            const numberedLines = lines.map((line, i) =>
              `<div class="code-line"><span class="line-number">${i + 1}</span><code class="hljs language-${lang}">${line || ' '}</code></div>`
            ).join('');
            return `
            ...
            return `
              <div class="code-container">
                ...
                <div class="code-content">
                  <pre>
                    <code class="hljs language-${lang}">${hljs.highlight(code, { language: lang }).value}</code>
                  </pre>
                </div>
              </div>
            `;
